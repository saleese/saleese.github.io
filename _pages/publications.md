...
nav: true
nav_order: 2
# The page heading repeated the navbar item the reader just clicked, and the
# description restated the grouping the five section headings already show. The
# title itself has to stay: it is what labels this page in the navbar and in the
# browser tab.
_styles: >
